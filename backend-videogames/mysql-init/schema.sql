...
CREATE TABLE `pedidos` (
  ...
  `subtotal` DECIMAL(10,2) NOT NULL, -- El costo de los productos
  `costo_envio` DECIMAL(10,2) NOT NULL, -- El costo de la estrategia de envío
  `total` DECIMAL(10,2) NOT NULL, -- La suma de subtotal + costo_envio
